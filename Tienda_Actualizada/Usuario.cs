...
namespace Tienda
{
    ...
    public class Usuario
    {
        ...
        public void filtrarListaAvanzada(string palabra, Inventario inventario)
        {
            bool esParte = false;
            ...
            foreach (Producto producto in refListaProductos)
            {
                ...
                int palabraContador = palabra.Length;
                int auxContador = 0;
                for (int i = 0; i < productoNombre.Length; i++)
                {
                    //iph
                    if (palabraContador == 0)
                    {
                    ...
                    else if (productoNombre[i] != palabra[auxContador])
                    {
                        palabraContador = palabra.Length;
                        auxContador = 0;
                    }
                    else if(productoNombre[i] == palabra[auxContador])
                    {
